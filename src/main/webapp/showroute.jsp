                      ...
                      <table class="table table-striped mb-0 text-center">
                       ...
                       //   boolean noRoute = Boolean.parseBoolean(request.getAttribute("noRoute").toString());
                     	// for (Route route : list) { 
                            ...
                            <td><a href="#" data-bs-toggle="modal"  data-bs-target="#editRouteModal">Edit</a></td>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control disabled" name="routeId" id="exampleFormControlInput1" placeholder="Route Id">
        </div>
        <div class="mb-3">
